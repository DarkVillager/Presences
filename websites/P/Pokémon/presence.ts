...
presence.on("UpdateData", async () => {
	...
	settingSetter();
	presenceData = getHost(hostname, pathname, href) ?? {
		largeImageKey: OtherAssets.Logo,
		startTimestamp: browsingTimestamp,
	};
	if (!presenceData.largeImageKey)
		presenceData.largeImageKey = OtherAssets.Logo;

	if (!presenceData.startTimestamp && !presenceData.endTimestamp)
		presenceData.startTimestamp = browsingTimestamp;

	if (!presenceData.details) presenceData.details = (await strings).browse;
	...
	// 			presenceData.largeImageKey = OtherAssets.Pokemonplay;
	// 			const title = document.querySelector(".full-article > h1");
	// 			if (title) {
	// 				presenceData.details = "Reading article:";
	// 				presenceData.state = title.textContent;
	...
	// 			presenceData.smallImageKey = OtherAssets.Pokeball;
	...
	// 				}
	// 				presenceData.largeImageKey = OtherAssets.Pokeball;
	...
	// 		) {
	// 			presenceData.largeImageKey = OtherAssets.Tcg;
	// 			presenceData.smallImageKey = Assets.Reading;
	...
	// 		) {
	// 			presenceData.largeImageKey = OtherAssets.Pokemontv;
	...
	// 		presenceData.largeImageKey = OtherAssets.Store;
	...
	// 		presenceData.largeImageKey = OtherAssets.Storejp;
	// 		if (document.location.pathname.includes("/cafe")) {
	// 			presenceData.largeImageKey = OtherAssets.Cafe;
	// 			if (document.location.pathname.includes("/pikachu_sweets")) {
	// 				presenceData.largeImageKey = OtherAssets.Sweets;
	...
	// 						presenceData.largeImageKey = OtherAssets.Storekr;
	// 						const title = document.querySelector(".medium-title");
	// 						if (title) {
	// 							presenceData.details = "Viewing product:";
	// 							presenceData.state = title.textContent;
	...
	// 					} else if (document.location.pathname.includes("/goods")) {
	// 						presenceData.smallImageKey = OtherAssets.Storejp;
